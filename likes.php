<div class="wrapper row">
    ...
    <div class="starter-template">
        <form class="form-inline" role="form" method="post" action="">
            ...
            От <input type="text" name="dateFrom" class="tcal form-control " value="" required
                      pattern="(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d">
            До <input type="text" name="dateTo" class="tcal form-control" value="" required
                      pattern="(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d"><br><br>
            <input type="text" class="form-control" placeholder='id или имя группы' name="groupId"
                   value="<?= $_POST['groupId'] ?>" required><br><br>
